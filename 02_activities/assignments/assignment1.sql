...
SELECT vendor_id, count(vendor_id) AS vendor_count
...
SELECT c.customer_last_name, c.customer_first_name, sum(cp.quantity*cp.cost_to_customer_per_qty) AS spent
FROM customer AS c
